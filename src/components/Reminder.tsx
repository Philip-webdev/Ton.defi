...
const navig = ()=> {
  ...
  return (
    ...
    backdropFilter: 'blur(4px)'
      ...
      >
        <Wrap><div className="flex items-center justify-between p-2 m-2 hover:shadow-[0_0_20px_rgb(36, 172, 242)] hover:shadow-lg transition-all duration-300 bg-red">
          <span style={{ display: 'flex', alignItems: 'center' }} className="p-2 m-2">
            <Store style={{margin: '10px', color:'rgb(36, 172, 242)', animationName: 'color-changing'}}  />Next Market Stats 
                 {isOpen ? (
          ...
          <Wrapper>
            <div className="space-y-4 p-2 m-2" style={{margin:'10px', padding:'20px'}}>
              ...
              <div className="flex gap-3">
                ...
                <textarea id='groclist' placeholder=" - 5 crates of Egg   (example)" style={{ height: '40px', width: '100%', background:'black', color:'white', border:'none', borderRadius:'5px', outline:'none'}} />
              </div>
